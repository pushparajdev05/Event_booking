  ...
  return (
    ...
    <div className="collapse navbar-collapse" id="navbarNav">
      <ul className="navbar-nav">
        ...
        <li className="nav-item">
          <a className="nav-link" href="/Registeration">Registeration</a>
        </li>
        <li className="nav-item"> 
          <a className="nav-link" href="/Registered-list">Registered List</a>
        </li>
      </ul>
    </div>
  </div>
